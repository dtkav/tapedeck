...
def mock_upstream():
    with requests_mock.Mocker() as m:
        ...
        m.get("http://example.com/test", additional_matcher=lambda req: parse_qs(req.query) == {'param1': ['value1'], 'param2': ['value2']} or req.query == '', text="response from GET /test with or without params", headers={"Content-Type": "application/json"})
        m.post(
